...
BASE_FEE = 15000
AINA_ZA_MAGARI = ["Bajaji / Pickup Ndogo", "Toyota Hilux", "Canter Ndogo", "Fuso Kubwa","pikipiki"]
...
c.execute("CREATE TABLE IF NOT EXISTS orders (id INTEGER PRIMARY KEY, mteja TEXT, simu_mteja TEXT, kutoka TEXT, kwenda TEXT, km REAL, jumla REAL, commission REAL, payout REAL, driver_id INTEGER, status TEXT, date TEXT)")q
conn.commit()
